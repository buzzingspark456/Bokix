...
export default function PrivacyPolicy() {
  return (
    ...
    >
      ...
      <PolicySection n={6} title="Hur länge vi sparar uppgifterna">
        <ul style={policyUl}>
      ...
      <PolicySection n={7} title="Dina rättigheter">
      ...
      <PolicySection n={8} title="Säkerhet">
        <p style={policyP}>
      ...
      <PolicySection n={9} title="Cookies">
        <p style={policyP}>
      ...
      <PolicySection n={10} title="Personuppgiftsbiträdesavtal (PUB) för dig som företagskund">
        <p style={policyP}>
      ...
      <PolicySection n={11} title="Ändringar i denna policy">
        <p style={policyP}>
