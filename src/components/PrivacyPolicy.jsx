    ...
    <div style={{ minHeight: '100vh', padding: '48px 24px', background: '#f8fafc', color: '#111827', fontFamily: 'Inter, system-ui, sans-serif' }}>
      <div style={{ maxWidth: '820px', margin: '0 auto', background: 'white', borderRadius: '24px', padding: '40px', boxShadow: '0 20px 60px rgba(15,23,42,0.08)' }}>
        ...
        <p style={{ marginBottom: '16px', lineHeight: 1.8, color: '#475569' }}>
          Bokix värnar om din personliga integritet. Den här integritetspolicyn förklarar vilken information vi samlar in, varför vi samlar in den, och hur vi skyddar den.
        </p>
        ...
        <p style={{ marginBottom: '16px', lineHeight: 1.8, color: '#475569' }}>
          Informationen används för att leverera och förbättra Bokix, hantera ditt konto och kommunicera med dig. Vi delar inte personuppgifter med tredje part utan ditt medgivande, förutom vad som krävs enligt lag.
        </p>
        <h2 style={{ marginTop: '32px', marginBottom: '12px', fontSize: '18px', fontWeight: 700 }}>Kontakt</h2>
        <p style={{ marginBottom: '16px', lineHeight: 1.8, color: '#475569' }}>
          Har du frågor om din integritet kan du kontakta oss via support@bokix.se eller via kontaktsidan i appen.
        </p>
